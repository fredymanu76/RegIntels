...
--
-- Prerequisites:
-- - Tables: exceptions, controls, regulatory_changes, regulatory_change_control_map
-- - The exceptions table should have: id, title, status, severity, source_id, source_type, opened_at
--
...
-- 1. The Risk Signal Hub feature will have all required database views
