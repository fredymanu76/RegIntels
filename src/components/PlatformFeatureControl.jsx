...
const PlatformFeatureControl = ({ supabase }) => {
  ...
  const platformFeatures = [
    ...
    // Issue & Breach Management (formerly Solution 4)
    {
      ...
      version: '1.0.0',
      solution: 'Issue & Breach Management',
    ...
    // Governance & Board Assurance (formerly Solution 5) - Board-Level Features
    {
      ...
      version: '1.0.0',
      solution: 'Governance & Board Assurance',
